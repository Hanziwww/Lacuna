...
def test_densify_guard_for_unimplemented():
    A = make_sample_csr()
    # divide is not implemented for sparse in this milestone
    try:
        xp.divide(A, A)
    except NotImplementedError:
        pass
    else:
        raise AssertionError("divide should raise NotImplementedError for sparse inputs")
